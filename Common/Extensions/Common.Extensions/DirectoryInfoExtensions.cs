...
namespace Common.Extensions
{
    ...
    public static class DirectoryInfoExtensions
    {
        ...
        {
            SearchOption searchOption = isIncludesSubDir ? SearchOption.AllDirectories : SearchOption.TopDirectoryOnly;
        ...
        {
            SearchOption searchOption = isIncludesSubDir ? SearchOption.AllDirectories : SearchOption.TopDirectoryOnly;
            long dirSize = di.DirSize(isIncludesSubDir);
            long sum = 0;
        ...
        {
            SearchOption searchOption = isIncludesSubDir ? SearchOption.AllDirectories : SearchOption.TopDirectoryOnly;
            int fileCount = di.FileCount(isIncludesSubDir);
