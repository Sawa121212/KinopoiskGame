...
namespace Common.Core.Components.Exceptions
{
    /// <summary>
    ...
    public class BaseException : Exception
    {
        ...
        {
            CultureInfo? currCulture = culture ?? CultureInfo.CurrentUICulture;
        ...
        {
            BaseException? ex = localLangName.IsNullOrEmpty()
            ...
            string localLangName = null, string localMessage = null) where TEx : Exception
        {
            ...
            {
                TEx? ex = (TEx)Activator.CreateInstance(typeof(TEx),
